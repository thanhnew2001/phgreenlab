                    ...
                    {data.children.map(b => {
                        ...
                        return (
                            <tr >
                                ...
                                Model: {b.Model} <br/>
                                SerialNumber: {b.name} <br/>
                                Type: {b.Type} <br/>
                                </td>
                               
                                <td type="datetime">
                                    {moment(b.DateSync).format("DD/MM/YYYY, HH:mm")}
                                </td>
                                ...
                                <a style={{color:'#087f23', fontWeight:'normal'}} href={url}> 
                                    Chart with Average Data </a> 
                                 <a style={{color:'#087f23', fontWeight:'normal'}} href={url1}> Chart by raw data </a></td>
                            </tr>
